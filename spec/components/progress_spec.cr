...
describe Term2::Components::Progress do
  it "initializes with defaults" do
    prog = Term2::Components::Progress.new
  ...
  it "updates percent" do
    ...
    msg = Term2::Components::Progress::SetPercentMsg.new(0.5)
    prog, _ = prog.update(msg)
    prog.percent.should eq 0.5

    msg = Term2::Components::Progress::IncrementMsg.new(0.1)
    prog, _ = prog.update(msg)
    prog.percent.should be_close(0.6, 0.001)

    # Clamping
    msg = Term2::Components::Progress::SetPercentMsg.new(1.5)
    prog, _ = prog.update(msg)
    prog.percent.should eq 1.0
  end

  it "renders correctly" do
    prog = Term2::Components::Progress.new(width: 10)
