...
describe Term2::Bubbles::List do
  it "initializes with items" do
    items = [
      Term2::Bubbles::List::DefaultItem.new("Item 1"),
      Term2::Bubbles::List::DefaultItem.new("Item 2"),
    ] of Term2::Bubbles::List::Item

    list = Term2::Bubbles::List.new(items)
    list.items.size.should eq 2
    list.index.should eq 0
  end

  it "initializes with string array" do
    list = Term2::Bubbles::List.new(["Item 1", "Item 2"])
    list.items.size.should eq 2
  ...
  it "initializes with tuple array" do
    list = Term2::Bubbles::List.new([{"Item 1", "Desc 1"}, {"Item 2", "Desc 2"}])
    list.items.size.should eq 2
    list.items[0].title.should eq "Item 1"
  ...
  it "renders" do
    items = [
      Term2::Bubbles::List::DefaultItem.new("Item 1", "Desc 1"),
      Term2::Bubbles::List::DefaultItem.new("Item 2", "Desc 2"),
    ] of Term2::Bubbles::List::Item

    list = Term2::Bubbles::List.new(items, width: 20, height: 10)
