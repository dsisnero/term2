...
alias Table = Term2::StyleTable::Table
alias StringData = Term2::StyleTable::StringData
alias Filter = Term2::StyleTable::Filter
...
def table_style(row, col)
  case
  when row == Term2::StyleTable::HEADER_ROW
    Term2::Style.new.padding(0, 1).align(Term2::Position::Center)
  when row.even?
    Term2::Style.new.padding(0, 1)
  else
    Term2::Style.new.padding(0, 1)
  end
end
...
describe "Lipgloss parity: table renderer" do
  around_each do |example|
    renderer = Term2::StyleRenderer.default
    previous_profile = renderer.color_profile
    renderer.color_profile = Term2::ColorProfile::ASCII
    begin
      example.run
    ensure
  ...
  it "renders example table" do
    header_style = Term2::Style.new.padding(0, 1).align(Term2::Position::Center)
    even_row_style = Term2::Style.new.padding(0, 1)
    odd_row_style = Term2::Style.new.padding(0, 1)
    ...
    table = Table.new
      .border(Term2::Border.normal)
      .border_style(Term2::Style.new.foreground(Term2::Color.indexed(99)))
  ...
  it "renders with margin and right alignment" do
    table = Table.new
      .border(Term2::Border.normal)
      .style_func(->(_r : Int32, _c : Int32) { Term2::Style.new.margin(0, 1).align(Term2::Position::Right) })
      .headers("LANGUAGE", "FORMAL", "INFORMAL")
  ...
  it "renders width expand" do
    ...
    Term2::Text.width(table.string).should eq(80)
