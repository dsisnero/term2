...
describe "Bubblezone example components", tags: "interactive" do
  it "renders tabs, lists, dialog, and history components" do
    ...
    Lipgloss::Text.strip_ansi(tabs.view(40)).should contain("One")
    ...
    Lipgloss::Text.strip_ansi(list.view(40, 10)).should contain("Fruits")
    Lipgloss::Text.strip_ansi(list.view(40, 10)).should contain("Apple")

    dialog = BubblezoneFullLipgloss::DialogComponent.new(Term2::Zone.new_prefix, "Are you sure?")
    Lipgloss::Text.strip_ansi(dialog.view(40, 10)).should contain("Are you sure?")

    history = BubblezoneFullLipgloss::HistoryComponent.new(Term2::Zone.new_prefix, ["Entry 1", "Entry 2"])
    Lipgloss::Text.strip_ansi(history.view(60, 5)).should contain("Entry 1")
  end
end
