...
This is a port of golang <https://github.com/charmbracelet/x/tree/main/ansi> to
Crystal language. Since it is a port, all logic must match the golang x/ansi
implementation only differening in Crystal language idioms and libs. If you have
a question, the go code is the source of truth. We want to port all go code and
go tests. The golang src is available at ./x/ansi
...
This is a Crystal port of the Go code from `./x/ansi`. Follow Crystal idioms and
best practices:
