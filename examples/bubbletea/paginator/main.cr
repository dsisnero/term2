...
class PaginatorModel
  ...
  def initialize
    ...
    @paginator.active_dot = Lipgloss::Style.new.foreground(Lipgloss::AdaptiveColor.new(light: Lipgloss::Color.indexed(235), dark: Lipgloss::Color.indexed(252))).render("•")
    @paginator.inactive_dot = Lipgloss::Style.new.foreground(Lipgloss::AdaptiveColor.new(light: Lipgloss::Color.indexed(250), dark: Lipgloss::Color.indexed(238))).render("•")
